...
import { FetchCategoryJoblist } from '../redux/slice/CategoryJoblistSlice'
...
const CategoryJoblist = () => {
  ...
  const showMoreItems = () => {
    ...
    const { id } = useParams()
    const{categoryjoblist_data}=useSelector((state)=>state?.categoryjoblist )

      
      const dispatch=useDispatch()
      useEffect(()=>{
        dispatch(FetchCategoryJoblist(id))
              },[])
    ...
    //   }, [id])
      ...
      // console.log('categoryjoblist_data',categoryjoblist_data);
            console.log('name',categoryjoblist_data?.data?.title);
            ...
            <div className="tab-class text-center wow fadeInUp" data-wow-delay="0.3s">
              <ul className="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                <li className="nav-item">
                  <a className="d-flex align-items-center text-start mx-3 ms-0 pb-3 "  href="/job-list">
...
<CategorySidebar/>
                ...
                <div className='col-md-10'>
                  <div className="tab-content">
                    ...
                    <h5 className="mb-3">{categoryjoblist_data?.data?.title}</h5>
                    {
     categoryjoblist_data?.data?.jobs?.slice(0, visible).map((item)=>{
      return(
        <>
